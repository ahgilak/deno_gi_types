 ...
 */
export function typeFindHelperForData(obj: Gst.Object | null, data: Uint8Array): [ /* returnType */ Gst.Caps | null, /* prob */ Gst.TypeFindProbability ]
/**
 * Tries to find what type of data is contained in the given `data,` the
 * assumption being that the data represents the beginning of the stream or
 * file.
 ...
 * @param extension extension of the media, or %NULL
 */
export function typeFindHelperForDataWithExtension(obj: Gst.Object | null, data: Uint8Array, extension: string | null): [ /* returnType */ Gst.Caps | null, /* prob */ Gst.TypeFindProbability ]
/**
...
export interface Aggregator {
    ...
    on(sigName: "samples-selected", callback: Aggregator.SamplesSelectedSignalCallback): number
    once(sigName: "samples-selected", callback: Aggregator.SamplesSelectedSignalCallback): number
    off(handlerId: number): number
...
export interface AggregatorPad {
    ...
    on(sigName: "buffer-consumed", callback: AggregatorPad.BufferConsumedSignalCallback): number
    once(sigName: "buffer-consumed", callback: AggregatorPad.BufferConsumedSignalCallback): number
    off(handlerId: number): number
...
export interface BaseParse {
    ...
    connect(sigName: "notify::disable-passthrough", callback: any): number
    on(sigName: "notify::disable-passthrough", callback: any): number
    once(sigName: "notify::disable-passthrough", callback: any): number
    off(handlerId: number): number
...
export interface DataQueue {
    ...
    on(sigName: "empty", callback: (...args: any[]) => void): number
    once(sigName: "empty", callback: (...args: any[]) => void): number
    off(handlerId: number): number
    emit(sigName: "empty", ...args: any[]): void
    connect(sigName: "full", callback: (...args: any[]) => void): number
    on(sigName: "full", callback: (...args: any[]) => void): number
    once(sigName: "full", callback: (...args: any[]) => void): number
    off(handlerId: number): number
