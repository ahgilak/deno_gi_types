...
export interface Store {
    ...
    on(sigName: "app-added", callback: Store.AppAddedSignalCallback): number
    once(sigName: "app-added", callback: Store.AppAddedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "app-added", ...args: any[]): void
    connect(sigName: "app-changed", callback: Store.AppChangedSignalCallback): number
    on(sigName: "app-changed", callback: Store.AppChangedSignalCallback): number
    once(sigName: "app-changed", callback: Store.AppChangedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "app-changed", ...args: any[]): void
    connect(sigName: "app-removed", callback: Store.AppRemovedSignalCallback): number
    on(sigName: "app-removed", callback: Store.AppRemovedSignalCallback): number
    once(sigName: "app-removed", callback: Store.AppRemovedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "app-removed", ...args: any[]): void
    connect(sigName: "changed", callback: Store.ChangedSignalCallback): number
    on(sigName: "changed", callback: Store.ChangedSignalCallback): number
    once(sigName: "changed", callback: Store.ChangedSignalCallback): number
    off(handlerId: number): number
