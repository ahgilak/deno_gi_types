...
export interface Client {
    ...
    on(sigName: "error", callback: Client.ErrorSignalCallback): number
    once(sigName: "error", callback: Client.ErrorSignalCallback): number
    ...
    on(sigName: "unreturned-error", callback: Client.UnreturnedErrorSignalCallback): number
    once(sigName: "unreturned-error", callback: Client.UnreturnedErrorSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "value-changed", callback: Client.ValueChangedSignalCallback): number
    once(sigName: "value-changed", callback: Client.ValueChangedSignalCallback): number
    off(handlerId: number): number
