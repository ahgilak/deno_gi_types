...
export interface FeedsPool {
    ...
    on(sigName: "feed-fail", callback: FeedsPool.FeedFailSignalCallback): number
    once(sigName: "feed-fail", callback: FeedsPool.FeedFailSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "feed-fail", ...args: any[]): void
    connect(sigName: "feed-fetching", callback: FeedsPool.FeedFetchingSignalCallback): number
    on(sigName: "feed-fetching", callback: FeedsPool.FeedFetchingSignalCallback): number
    once(sigName: "feed-fetching", callback: FeedsPool.FeedFetchingSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "feed-fetching", ...args: any[]): void
    connect(sigName: "feed-ready", callback: FeedsPool.FeedReadySignalCallback): number
    on(sigName: "feed-ready", callback: FeedsPool.FeedReadySignalCallback): number
    once(sigName: "feed-ready", callback: FeedsPool.FeedReadySignalCallback): number
    off(handlerId: number): number
...
export interface FeedsPublisher {
    ...
    deleteSubscription(topic: FeedChannel, callback: string): void
    newSubscription(topic: FeedChannel, callback: string): void
    ...
    on(sigName: "delete-subscription", callback: FeedsPublisher.DeleteSubscriptionSignalCallback): number
    once(sigName: "delete-subscription", callback: FeedsPublisher.DeleteSubscriptionSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "new-subscription", callback: FeedsPublisher.NewSubscriptionSignalCallback): number
    once(sigName: "new-subscription", callback: FeedsPublisher.NewSubscriptionSignalCallback): number
    off(handlerId: number): number
...
export interface FeedsSubscriber {
    ...
    on(sigName: "notification-received", callback: FeedsSubscriber.NotificationReceivedSignalCallback): number
    once(sigName: "notification-received", callback: FeedsSubscriber.NotificationReceivedSignalCallback): number
    off(handlerId: number): number
