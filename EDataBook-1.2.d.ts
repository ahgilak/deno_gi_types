...
export interface BookBackend {
    ...
    on(sigName: "closed", callback: BookBackend.ClosedSignalCallback): number
    once(sigName: "closed", callback: BookBackend.ClosedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "closed", ...args: any[]): void
    connect(sigName: "shutdown", callback: BookBackend.ShutdownSignalCallback): number
    on(sigName: "shutdown", callback: BookBackend.ShutdownSignalCallback): number
    once(sigName: "shutdown", callback: BookBackend.ShutdownSignalCallback): number
    off(handlerId: number): number
...
export interface BookCache extends EDataServer.Extensible {
    ...
    // Has conflict: dupContactRevision(contact: EBookContacts.Contact): string
    dupLocale(): string
    /**
    ...
    on(sigName: "dup-contact-revision", callback: BookCache.DupContactRevisionSignalCallback): number
    once(sigName: "dup-contact-revision", callback: BookCache.DupContactRevisionSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "e164-changed", callback: BookCache.E164ChangedSignalCallback): number
    once(sigName: "e164-changed", callback: BookCache.E164ChangedSignalCallback): number
    off(handlerId: number): number
...
export interface BookMetaBackend {
    ...
    // Has conflict: getChangesSync(lastSyncTag: string | null, isRepeat: boolean, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outNewSyncTag */ string, /* outRepeat */ boolean, /* outCreatedObjects */ BookMetaBackendInfo[], /* outModifiedObjects */ BookMetaBackendInfo[], /* outRemovedObjects */ BookMetaBackendInfo[] ]
    /**
    ...
    // Has conflict: listExistingSync(cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outNewSyncTag */ string, /* outExistingObjects */ BookMetaBackendInfo[] ]
    // Has conflict: loadContactSync(uid: string, extra: string | null, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outContact */ EBookContacts.Contact, /* outExtra */ string ]
    /**
    ...
    // Has conflict: saveContactSync(overwriteExisting: boolean, conflictResolution: EDataServer.ConflictResolution, contact: EBookContacts.Contact, extra: string | null, opflags: number, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outNewUid */ string, /* outNewExtra */ string ]
    /**
    ...
    on(sigName: "refresh-completed", callback: BookMetaBackend.RefreshCompletedSignalCallback): number
    once(sigName: "refresh-completed", callback: BookMetaBackend.RefreshCompletedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "source-changed", callback: BookMetaBackend.SourceChangedSignalCallback): number
    once(sigName: "source-changed", callback: BookMetaBackend.SourceChangedSignalCallback): number
    off(handlerId: number): number
...
export interface BookSqlite extends EDataServer.Extensible {
    ...
    beforeInsertContact(db: object | null, contact: EBookContacts.Contact, extra: string, replace: boolean, cancellable: Gio.Cancellable | null): boolean
    beforeRemoveContact(db: object | null, contactUid: string, cancellable: Gio.Cancellable | null): boolean
    ...
    on(sigName: "before-insert-contact", callback: BookSqlite.BeforeInsertContactSignalCallback): number
    once(sigName: "before-insert-contact", callback: BookSqlite.BeforeInsertContactSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "before-remove-contact", callback: BookSqlite.BeforeRemoveContactSignalCallback): number
    once(sigName: "before-remove-contact", callback: BookSqlite.BeforeRemoveContactSignalCallback): number
    off(handlerId: number): number
...
export interface DataBookCursor {
    ...
    loadLocale(): [ /* returnType */ boolean, /* locale */ string ]
...
export interface DataBookCursorCache {
    ...
    connect(sigName: "notify::book-cache", callback: any): number
    on(sigName: "notify::book-cache", callback: any): number
    once(sigName: "notify::book-cache", callback: any): number
    off(handlerId: number): number
...
export interface DataBookCursorSqlite {
    ...
    off(handlerId: number): number
    emit(sigName: "notify::cursor", ...args: any[]): void
    connect(sigName: "notify::ebsql", callback: any): number
    on(sigName: "notify::ebsql", callback: any): number
    once(sigName: "notify::ebsql", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::ebsql", ...args: any[]): void
    connect(sigName: "notify::revision-key", callback: any): number
    on(sigName: "notify::revision-key", callback: any): number
    once(sigName: "notify::revision-key", callback: any): number
    off(handlerId: number): number
