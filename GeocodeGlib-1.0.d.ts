...
export interface Forward {
    ...
    connect(sigName: "notify::answer-count", callback: any): number
    on(sigName: "notify::answer-count", callback: any): number
    once(sigName: "notify::answer-count", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::answer-count", ...args: any[]): void
    connect(sigName: "notify::bounded", callback: any): number
    on(sigName: "notify::bounded", callback: any): number
    once(sigName: "notify::bounded", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::bounded", ...args: any[]): void
    connect(sigName: "notify::search-area", callback: any): number
    on(sigName: "notify::search-area", callback: any): number
    once(sigName: "notify::search-area", callback: any): number
    off(handlerId: number): number
...
export interface Location {
    ...
    connect(sigName: "notify::crs", callback: any): number
    on(sigName: "notify::crs", callback: any): number
    once(sigName: "notify::crs", callback: any): number
    off(handlerId: number): number
...
export interface Nominatim extends Backend {
    ...
    query(uri: string, cancellable: Gio.Cancellable | null): string
    queryAsync(uri: string, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void
    queryFinish(res: Gio.AsyncResult): string

    // Class property signals of GeocodeGlib-1.0.GeocodeGlib.Nominatim

    connect(sigName: "notify::base-url", callback: any): number
    on(sigName: "notify::base-url", callback: any): number
    once(sigName: "notify::base-url", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::base-url", ...args: any[]): void
    connect(sigName: "notify::maintainer-email-address", callback: any): number
    on(sigName: "notify::maintainer-email-address", callback: any): number
    once(sigName: "notify::maintainer-email-address", callback: any): number
    off(handlerId: number): number
...
export interface Place {
    ...
    connect(sigName: "notify::administrative-area", callback: any): number
    on(sigName: "notify::administrative-area", callback: any): number
    once(sigName: "notify::administrative-area", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::continent", callback: any): number
    on(sigName: "notify::continent", callback: any): number
    once(sigName: "notify::continent", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::county", callback: any): number
    on(sigName: "notify::county", callback: any): number
    once(sigName: "notify::county", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::osm-id", callback: any): number
    on(sigName: "notify::osm-id", callback: any): number
    once(sigName: "notify::osm-id", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::osm-id", ...args: any[]): void
    connect(sigName: "notify::osm-type", callback: any): number
    on(sigName: "notify::osm-type", callback: any): number
    once(sigName: "notify::osm-type", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::osm-type", ...args: any[]): void
    connect(sigName: "notify::place-type", callback: any): number
    on(sigName: "notify::place-type", callback: any): number
    once(sigName: "notify::place-type", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::street-address", callback: any): number
    on(sigName: "notify::street-address", callback: any): number
    once(sigName: "notify::street-address", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::street-address", ...args: any[]): void
    connect(sigName: "notify::town", callback: any): number
    on(sigName: "notify::town", callback: any): number
    once(sigName: "notify::town", callback: any): number
    off(handlerId: number): number
