...
export interface ContextManager {
    ...
    connect(sigName: "notify::context-filter", callback: any): number
    on(sigName: "notify::context-filter", callback: any): number
    once(sigName: "notify::context-filter", callback: any): number
    off(handlerId: number): number
