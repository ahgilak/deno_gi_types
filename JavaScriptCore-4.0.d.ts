...
export interface Context {
    ...
    connect(sigName: "notify::virtual-machine", callback: any): number
    on(sigName: "notify::virtual-machine", callback: any): number
    once(sigName: "notify::virtual-machine", callback: any): number
    off(handlerId: number): number
...
export interface WeakValue {
    ...
    on(sigName: "cleared", callback: WeakValue.ClearedSignalCallback): number
    once(sigName: "cleared", callback: WeakValue.ClearedSignalCallback): number
    off(handlerId: number): number
