...
export interface InfoBar extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
    ...
    connect(sigName: "notify::handle-close-response", callback: any): number
    on(sigName: "notify::handle-close-response", callback: any): number
    once(sigName: "notify::handle-close-response", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::handle-close-response", ...args: any[]): void
    connect(sigName: "notify::icon-from-message-type", callback: any): number
    on(sigName: "notify::icon-from-message-type", callback: any): number
    once(sigName: "notify::icon-from-message-type", callback: any): number
    off(handlerId: number): number
