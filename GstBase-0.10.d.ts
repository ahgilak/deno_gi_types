...
export interface GstDataQueue {
    ...
    on(sigName: "empty", callback: GstDataQueue.EmptySignalCallback): number
    once(sigName: "empty", callback: GstDataQueue.EmptySignalCallback): number
    off(handlerId: number): number
    emit(sigName: "empty", ...args: any[]): void
    connect(sigName: "full", callback: GstDataQueue.FullSignalCallback): number
    on(sigName: "full", callback: GstDataQueue.FullSignalCallback): number
    once(sigName: "full", callback: GstDataQueue.FullSignalCallback): number
    off(handlerId: number): number
