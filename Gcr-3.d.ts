...
export interface Collection {
    ...
    on(sigName: "added", callback: Collection.AddedSignalCallback): number
    once(sigName: "added", callback: Collection.AddedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "added", ...args: any[]): void
    connect(sigName: "removed", callback: Collection.RemovedSignalCallback): number
    on(sigName: "removed", callback: Collection.RemovedSignalCallback): number
    once(sigName: "removed", callback: Collection.RemovedSignalCallback): number
    off(handlerId: number): number
...
export interface Prompt {
    ...
    on(sigName: "prompt-close", callback: Prompt.PromptCloseSignalCallback): number
    once(sigName: "prompt-close", callback: Prompt.PromptCloseSignalCallback): number
    off(handlerId: number): number
...
export interface CertificateRequest {
    ...
    connect(sigName: "notify::private-key", callback: any): number
    on(sigName: "notify::private-key", callback: any): number
    once(sigName: "notify::private-key", callback: any): number
    off(handlerId: number): number
...
export interface FilterCollection extends Collection {
    ...
    connect(sigName: "notify::underlying", callback: any): number
    on(sigName: "notify::underlying", callback: any): number
    once(sigName: "notify::underlying", callback: any): number
    off(handlerId: number): number
...
export interface Parser {
    ...
    on(sigName: "authenticate", callback: Parser.AuthenticateSignalCallback): number
    once(sigName: "authenticate", callback: Parser.AuthenticateSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "authenticate", ...args: any[]): void
    connect(sigName: "parsed", callback: Parser.ParsedSignalCallback): number
    on(sigName: "parsed", callback: Parser.ParsedSignalCallback): number
    once(sigName: "parsed", callback: Parser.ParsedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "parsed", ...args: any[]): void

    // Class property signals of Gcr-3.Gcr.Parser

    connect(sigName: "notify::parsed-attributes", callback: any): number
    on(sigName: "notify::parsed-attributes", callback: any): number
    once(sigName: "notify::parsed-attributes", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::parsed-attributes", ...args: any[]): void
    connect(sigName: "notify::parsed-description", callback: any): number
    on(sigName: "notify::parsed-description", callback: any): number
    once(sigName: "notify::parsed-description", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::parsed-description", ...args: any[]): void
    connect(sigName: "notify::parsed-label", callback: any): number
    on(sigName: "notify::parsed-label", callback: any): number
    once(sigName: "notify::parsed-label", callback: any): number
    off(handlerId: number): number
...
export interface SystemPrompt extends Prompt, Gio.AsyncInitable, Gio.Initable {
    ...
    connect(sigName: "notify::secret-exchange", callback: any): number
    on(sigName: "notify::secret-exchange", callback: any): number
    once(sigName: "notify::secret-exchange", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::secret-exchange", ...args: any[]): void
    connect(sigName: "notify::timeout-seconds", callback: any): number
    on(sigName: "notify::timeout-seconds", callback: any): number
    once(sigName: "notify::timeout-seconds", callback: any): number
    off(handlerId: number): number
...
export interface SystemPrompter {
    ...
    on(sigName: "new-prompt", callback: SystemPrompter.NewPromptSignalCallback): number
    once(sigName: "new-prompt", callback: SystemPrompter.NewPromptSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "new-prompt", ...args: any[]): void

    // Class property signals of Gcr-3.Gcr.SystemPrompter

    connect(sigName: "notify::prompt-type", callback: any): number
    on(sigName: "notify::prompt-type", callback: any): number
    once(sigName: "notify::prompt-type", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::prompt-type", ...args: any[]): void
    connect(sigName: "notify::prompting", callback: any): number
    on(sigName: "notify::prompting", callback: any): number
    once(sigName: "notify::prompting", callback: any): number
    off(handlerId: number): number
