...
export interface Endpoint {
    ...
    connect(sigName: "notify::sparql-connection", callback: any): number
    on(sigName: "notify::sparql-connection", callback: any): number
    once(sigName: "notify::sparql-connection", callback: any): number
    off(handlerId: number): number
...
export interface EndpointHttp extends Gio.Initable {
    ...
    on(sigName: "block-remote-address", callback: EndpointHttp.BlockRemoteAddressSignalCallback): number
    once(sigName: "block-remote-address", callback: EndpointHttp.BlockRemoteAddressSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "block-remote-address", ...args: any[]): void

    // Class property signals of Tracker-3.0.Tracker.EndpointHttp

    connect(sigName: "notify::http-certificate", callback: any): number
    on(sigName: "notify::http-certificate", callback: any): number
    once(sigName: "notify::http-certificate", callback: any): number
    off(handlerId: number): number
...
export interface Notifier {
    ...
    on(sigName: "events", callback: Notifier.EventsSignalCallback): number
    once(sigName: "events", callback: Notifier.EventsSignalCallback): number
    off(handlerId: number): number
...
export interface SparqlStatement {
    ...
    off(handlerId: number): number
    emit(sigName: "notify::connection", ...args: any[]): void
    connect(sigName: "notify::sparql", callback: any): number
    on(sigName: "notify::sparql", callback: any): number
    once(sigName: "notify::sparql", callback: any): number
    off(handlerId: number): number
