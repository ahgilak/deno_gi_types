...
export module Onscreen {
    ...
    export interface ConstructorProperties extends Framebuffer.ConstructorProperties, Object.ConstructorProperties {
    }

}

export interface Onscreen extends Framebuffer {
...
export interface TexturePixmapX11 {
...
export interface TextureRectangle extends Texture {
...
export interface OnscreenResizeClosure {
}
...
export interface _EulerSizeCheck {
...
export interface _QuaternionSizeCheck {
