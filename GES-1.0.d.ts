...
export module MetaContainer {
    ...
    export interface NotifyMetaSignalCallback {
        (key: string, value: any | null): void
    }
...
export interface MetaContainer {
    ...
    on(sigName: "notify-meta", callback: MetaContainer.NotifyMetaSignalCallback): number
    once(sigName: "notify-meta", callback: MetaContainer.NotifyMetaSignalCallback): number
    off(handlerId: number): number
...
export interface Asset extends MetaContainer, Gio.AsyncInitable, Gio.Initable {
    ...
    requestIdUpdate(proposedNewId: string, error: GLib.Error): boolean
    startLoading(): AssetLoadingReturn

    // Class property signals of GES-1.0.GES.Asset

    connect(sigName: "notify::extractable-type", callback: any): number
    on(sigName: "notify::extractable-type", callback: any): number
    once(sigName: "notify::extractable-type", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::proxy-target", callback: any): number
    on(sigName: "notify::proxy-target", callback: any): number
    once(sigName: "notify::proxy-target", callback: any): number
    off(handlerId: number): number
...
export interface AudioSource extends Extractable, MetaContainer {
    ...
    connect(sigName: "notify::auto-clamp-control-sources", callback: any): number
    on(sigName: "notify::auto-clamp-control-sources", callback: any): number
    once(sigName: "notify::auto-clamp-control-sources", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::auto-clamp-control-sources", ...args: any[]): void
    connect(sigName: "notify::has-internal-source", callback: any): number
    on(sigName: "notify::has-internal-source", callback: any): number
    once(sigName: "notify::has-internal-source", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::track-type", callback: any): number
    on(sigName: "notify::track-type", callback: any): number
    once(sigName: "notify::track-type", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::track-type", ...args: any[]): void
    connect(sigName: "notify::in-point", callback: any): number
    on(sigName: "notify::in-point", callback: any): number
    once(sigName: "notify::in-point", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::in-point", ...args: any[]): void
    connect(sigName: "notify::max-duration", callback: any): number
    on(sigName: "notify::max-duration", callback: any): number
    once(sigName: "notify::max-duration", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::max-duration", ...args: any[]): void
    connect(sigName: "notify::serialize", callback: any): number
    on(sigName: "notify::serialize", callback: any): number
    once(sigName: "notify::serialize", callback: any): number
    off(handlerId: number): number
...
export interface AudioTrack extends MetaContainer, Gst.ChildProxy {
    ...
    off(handlerId: number): number
    emit(sigName: "notify::id", ...args: any[]): void
    connect(sigName: "notify::mixing", callback: any): number
    on(sigName: "notify::mixing", callback: any): number
    once(sigName: "notify::mixing", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::mixing", ...args: any[]): void
    connect(sigName: "notify::restriction-caps", callback: any): number
    on(sigName: "notify::restriction-caps", callback: any): number
    once(sigName: "notify::restriction-caps", callback: any): number
    off(handlerId: number): number
...
export interface BaseEffectClip extends Extractable, MetaContainer {
    ...
    connect(sigName: "notify::duration-limit", callback: any): number
    on(sigName: "notify::duration-limit", callback: any): number
    once(sigName: "notify::duration-limit", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::duration-limit", ...args: any[]): void
    connect(sigName: "notify::layer", callback: any): number
    on(sigName: "notify::layer", callback: any): number
    once(sigName: "notify::layer", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::layer", ...args: any[]): void
    connect(sigName: "notify::supported-formats", callback: any): number
    on(sigName: "notify::supported-formats", callback: any): number
    once(sigName: "notify::supported-formats", callback: any): number
    off(handlerId: number): number
...
export interface Container extends Extractable, MetaContainer {
    ...
    on(sigName: "child-added", callback: Container.ChildAddedSignalCallback): number
    once(sigName: "child-added", callback: Container.ChildAddedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "child-added", ...args: any[]): void
    connect(sigName: "child-removed", callback: Container.ChildRemovedSignalCallback): number
    on(sigName: "child-removed", callback: Container.ChildRemovedSignalCallback): number
    once(sigName: "child-removed", callback: Container.ChildRemovedSignalCallback): number
    off(handlerId: number): number
...
export interface Effect extends Extractable, MetaContainer {
     ...
     * Example: "videobalance saturation=1.5 hue=+0.5"
     */
    readonly binDescription: string
    ...
    connect(sigName: "notify::bin-description", callback: any): number
    on(sigName: "notify::bin-description", callback: any): number
    once(sigName: "notify::bin-description", callback: any): number
    off(handlerId: number): number
...
export interface EffectClip extends Extractable, MetaContainer {
     ...
     * Example: "audiopanorama panorama=1.0"
     */
    readonly audioBinDescription: string
    /**
     * The description of the video track of the effect bin with a gst-launch-style
     * pipeline description. This should be used for test purposes.
     * 
     * Example: "videobalance saturation=1.5 hue=+0.5"
     */
    readonly videoBinDescription: string
    ...
    connect(sigName: "notify::audio-bin-description", callback: any): number
    on(sigName: "notify::audio-bin-description", callback: any): number
    once(sigName: "notify::audio-bin-description", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::audio-bin-description", ...args: any[]): void
    connect(sigName: "notify::video-bin-description", callback: any): number
    on(sigName: "notify::video-bin-description", callback: any): number
    once(sigName: "notify::video-bin-description", callback: any): number
    off(handlerId: number): number
...
export interface Layer extends Extractable, MetaContainer {
    ...
    on(sigName: "active-changed", callback: Layer.ActiveChangedSignalCallback): number
    once(sigName: "active-changed", callback: Layer.ActiveChangedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "clip-added", callback: Layer.ClipAddedSignalCallback): number
    once(sigName: "clip-added", callback: Layer.ClipAddedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "clip-added", ...args: any[]): void
    connect(sigName: "clip-removed", callback: Layer.ClipRemovedSignalCallback): number
    on(sigName: "clip-removed", callback: Layer.ClipRemovedSignalCallback): number
    once(sigName: "clip-removed", callback: Layer.ClipRemovedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "clip-removed", ...args: any[]): void

    // Class property signals of GES-1.0.GES.Layer

    connect(sigName: "notify::auto-transition", callback: any): number
    on(sigName: "notify::auto-transition", callback: any): number
    once(sigName: "notify::auto-transition", callback: any): number
    off(handlerId: number): number
...
export interface MarkerList {
    ...
    on(sigName: "marker-added", callback: MarkerList.MarkerAddedSignalCallback): number
    once(sigName: "marker-added", callback: MarkerList.MarkerAddedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "marker-moved", callback: MarkerList.MarkerMovedSignalCallback): number
    once(sigName: "marker-moved", callback: MarkerList.MarkerMovedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "marker-removed", callback: MarkerList.MarkerRemovedSignalCallback): number
    once(sigName: "marker-removed", callback: MarkerList.MarkerRemovedSignalCallback): number
    off(handlerId: number): number
...
export interface Pipeline extends Gst.ChildProxy, GstVideo.VideoOverlay {
    ...
    connect(sigName: "notify::audio-filter", callback: any): number
    on(sigName: "notify::audio-filter", callback: any): number
    once(sigName: "notify::audio-filter", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::audio-filter", ...args: any[]): void
    connect(sigName: "notify::audio-sink", callback: any): number
    on(sigName: "notify::audio-sink", callback: any): number
    once(sigName: "notify::audio-sink", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::timeline", callback: any): number
    on(sigName: "notify::timeline", callback: any): number
    once(sigName: "notify::timeline", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::timeline", ...args: any[]): void
    connect(sigName: "notify::video-filter", callback: any): number
    on(sigName: "notify::video-filter", callback: any): number
    once(sigName: "notify::video-filter", callback: any): number
    off(handlerId: number): number
...
export module Project {
    ...
    export interface ErrorLoadingAssetSignalCallback {
        (error: GLib.Error, id: string, extractableType: GObject.GType): void
    }
...
export interface Project extends MetaContainer, Gio.AsyncInitable, Gio.Initable {
    ...
    loadingError(error: GLib.Error, id: string, extractableType: GObject.GType): boolean
    missingUri(error: GLib.Error, wrongAsset: Asset): string

    // Own signals of GES-1.0.GES.Project

    connect(sigName: "asset-added", callback: Project.AssetAddedSignalCallback): number
    on(sigName: "asset-added", callback: Project.AssetAddedSignalCallback): number
    once(sigName: "asset-added", callback: Project.AssetAddedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "asset-added", ...args: any[]): void
    connect(sigName: "asset-loading", callback: Project.AssetLoadingSignalCallback): number
    on(sigName: "asset-loading", callback: Project.AssetLoadingSignalCallback): number
    once(sigName: "asset-loading", callback: Project.AssetLoadingSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "asset-loading", ...args: any[]): void
    connect(sigName: "asset-removed", callback: Project.AssetRemovedSignalCallback): number
    on(sigName: "asset-removed", callback: Project.AssetRemovedSignalCallback): number
    once(sigName: "asset-removed", callback: Project.AssetRemovedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "asset-removed", ...args: any[]): void
    connect(sigName: "error-loading", callback: Project.ErrorLoadingSignalCallback): number
    on(sigName: "error-loading", callback: Project.ErrorLoadingSignalCallback): number
    once(sigName: "error-loading", callback: Project.ErrorLoadingSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "error-loading-asset", callback: Project.ErrorLoadingAssetSignalCallback): number
    once(sigName: "error-loading-asset", callback: Project.ErrorLoadingAssetSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "error-loading-asset", id: string, extractableType: GObject.GType, ...args: any[]): void
    connect(sigName: "loaded", callback: Project.LoadedSignalCallback): number
    on(sigName: "loaded", callback: Project.LoadedSignalCallback): number
    once(sigName: "loaded", callback: Project.LoadedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "loaded", ...args: any[]): void
    connect(sigName: "loading", callback: Project.LoadingSignalCallback): number
    on(sigName: "loading", callback: Project.LoadingSignalCallback): number
    once(sigName: "loading", callback: Project.LoadingSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "loading", ...args: any[]): void
    connect(sigName: "missing-uri", callback: Project.MissingUriSignalCallback): number
    on(sigName: "missing-uri", callback: Project.MissingUriSignalCallback): number
    once(sigName: "missing-uri", callback: Project.MissingUriSignalCallback): number
    off(handlerId: number): number
...
export interface TestClip extends Extractable, MetaContainer {
    ...
    connect(sigName: "notify::freq", callback: any): number
    on(sigName: "notify::freq", callback: any): number
    once(sigName: "notify::freq", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::vpattern", callback: any): number
    on(sigName: "notify::vpattern", callback: any): number
    once(sigName: "notify::vpattern", callback: any): number
    off(handlerId: number): number
...
export interface TextOverlayClip extends Extractable, MetaContainer {
    ...
    connect(sigName: "notify::halignment", callback: any): number
    on(sigName: "notify::halignment", callback: any): number
    once(sigName: "notify::halignment", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::valignment", callback: any): number
    on(sigName: "notify::valignment", callback: any): number
    once(sigName: "notify::valignment", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::valignment", ...args: any[]): void
    connect(sigName: "notify::xpos", callback: any): number
    on(sigName: "notify::xpos", callback: any): number
    once(sigName: "notify::xpos", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::xpos", ...args: any[]): void
    connect(sigName: "notify::ypos", callback: any): number
    on(sigName: "notify::ypos", callback: any): number
    once(sigName: "notify::ypos", callback: any): number
    off(handlerId: number): number
...
export interface Timeline extends Extractable, MetaContainer, Gst.ChildProxy {
    ...
    on(sigName: "commited", callback: Timeline.CommitedSignalCallback): number
    once(sigName: "commited", callback: Timeline.CommitedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "commited", ...args: any[]): void
    connect(sigName: "group-added", callback: Timeline.GroupAddedSignalCallback): number
    on(sigName: "group-added", callback: Timeline.GroupAddedSignalCallback): number
    once(sigName: "group-added", callback: Timeline.GroupAddedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "group-added", ...args: any[]): void
    connect(sigName: "group-removed", callback: Timeline.GroupRemovedSignalCallback): number
    on(sigName: "group-removed", callback: Timeline.GroupRemovedSignalCallback): number
    once(sigName: "group-removed", callback: Timeline.GroupRemovedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "layer-added", callback: Timeline.LayerAddedSignalCallback): number
    once(sigName: "layer-added", callback: Timeline.LayerAddedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "layer-added", ...args: any[]): void
    connect(sigName: "layer-removed", callback: Timeline.LayerRemovedSignalCallback): number
    on(sigName: "layer-removed", callback: Timeline.LayerRemovedSignalCallback): number
    once(sigName: "layer-removed", callback: Timeline.LayerRemovedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "select-element-track", callback: Timeline.SelectElementTrackSignalCallback): number
    once(sigName: "select-element-track", callback: Timeline.SelectElementTrackSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "select-tracks-for-object", callback: Timeline.SelectTracksForObjectSignalCallback): number
    once(sigName: "select-tracks-for-object", callback: Timeline.SelectTracksForObjectSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "snapping-ended", callback: Timeline.SnappingEndedSignalCallback): number
    once(sigName: "snapping-ended", callback: Timeline.SnappingEndedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "snapping-started", callback: Timeline.SnappingStartedSignalCallback): number
    once(sigName: "snapping-started", callback: Timeline.SnappingStartedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "track-added", callback: Timeline.TrackAddedSignalCallback): number
    once(sigName: "track-added", callback: Timeline.TrackAddedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "track-added", ...args: any[]): void
    connect(sigName: "track-removed", callback: Timeline.TrackRemovedSignalCallback): number
    on(sigName: "track-removed", callback: Timeline.TrackRemovedSignalCallback): number
    once(sigName: "track-removed", callback: Timeline.TrackRemovedSignalCallback): number
    off(handlerId: number): number
    ...
    off(handlerId: number): number
    emit(sigName: "notify::duration", ...args: any[]): void
    connect(sigName: "notify::snapping-distance", callback: any): number
    on(sigName: "notify::snapping-distance", callback: any): number
    once(sigName: "notify::snapping-distance", callback: any): number
    off(handlerId: number): number
...
export interface TimelineElement extends Extractable, MetaContainer {
    ...
    on(sigName: "child-property-added", callback: TimelineElement.ChildPropertyAddedSignalCallback): number
    once(sigName: "child-property-added", callback: TimelineElement.ChildPropertyAddedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "child-property-removed", callback: TimelineElement.ChildPropertyRemovedSignalCallback): number
    once(sigName: "child-property-removed", callback: TimelineElement.ChildPropertyRemovedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "deep-notify", callback: TimelineElement.DeepNotifySignalCallback): number
    once(sigName: "deep-notify", callback: TimelineElement.DeepNotifySignalCallback): number
    off(handlerId: number): number
...
export interface Track extends MetaContainer, Gst.ChildProxy {
    ...
    on(sigName: "commited", callback: Track.CommitedSignalCallback): number
    once(sigName: "commited", callback: Track.CommitedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "commited", ...args: any[]): void
    connect(sigName: "track-element-added", callback: Track.TrackElementAddedSignalCallback): number
    on(sigName: "track-element-added", callback: Track.TrackElementAddedSignalCallback): number
    once(sigName: "track-element-added", callback: Track.TrackElementAddedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "track-element-removed", callback: Track.TrackElementRemovedSignalCallback): number
    once(sigName: "track-element-removed", callback: Track.TrackElementRemovedSignalCallback): number
    off(handlerId: number): number
...
export interface TrackElement extends Extractable, MetaContainer {
    ...
    on(sigName: "control-binding-added", callback: TrackElement.ControlBindingAddedSignalCallback): number
    once(sigName: "control-binding-added", callback: TrackElement.ControlBindingAddedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "control-binding-removed", callback: TrackElement.ControlBindingRemovedSignalCallback): number
    once(sigName: "control-binding-removed", callback: TrackElement.ControlBindingRemovedSignalCallback): number
    off(handlerId: number): number
...
export interface UriClip extends Extractable, MetaContainer {
    ...
    connect(sigName: "notify::is-image", callback: any): number
    on(sigName: "notify::is-image", callback: any): number
    once(sigName: "notify::is-image", callback: any): number
    off(handlerId: number): number
...
export interface UriClipAsset extends MetaContainer, Gio.AsyncInitable, Gio.Initable {
    ...
    off(handlerId: number): number
    emit(sigName: "notify::duration", ...args: any[]): void
    connect(sigName: "notify::is-nested-timeline", callback: any): number
    on(sigName: "notify::is-nested-timeline", callback: any): number
    once(sigName: "notify::is-nested-timeline", callback: any): number
    off(handlerId: number): number
...
export interface VideoTransition extends Extractable, MetaContainer {
    ...
    connect(sigName: "notify::border", callback: any): number
    on(sigName: "notify::border", callback: any): number
    once(sigName: "notify::border", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::border", ...args: any[]): void
    connect(sigName: "notify::invert", callback: any): number
    on(sigName: "notify::invert", callback: any): number
    once(sigName: "notify::invert", callback: any): number
    off(handlerId: number): number
...
export interface ProjectClass {
    ...
    loadingError: (self: Project, error: GLib.Error, id: string, extractableType: GObject.GType) => boolean
