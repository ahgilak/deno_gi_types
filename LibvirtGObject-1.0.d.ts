...
import type * as LibvirtGLib from './LibvirtGLib-1.0.js';
import type * as GLib from './GLib-2.0.js';
import type * as LibvirtGConfig from './LibvirtGConfig-1.0.js';
...
export interface Connection {
    ...
    on(sigName: "connection-closed", callback: Connection.ConnectionClosedSignalCallback): number
    once(sigName: "connection-closed", callback: Connection.ConnectionClosedSignalCallback): number
    ...
    on(sigName: "connection-opened", callback: Connection.ConnectionOpenedSignalCallback): number
    once(sigName: "connection-opened", callback: Connection.ConnectionOpenedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "domain-added", callback: Connection.DomainAddedSignalCallback): number
    once(sigName: "domain-added", callback: Connection.DomainAddedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "domain-removed", callback: Connection.DomainRemovedSignalCallback): number
    once(sigName: "domain-removed", callback: Connection.DomainRemovedSignalCallback): number
    off(handlerId: number): number
...
export interface Domain {
    ...
    on(sigName: "pmsuspended", callback: Domain.PmsuspendedSignalCallback): number
    once(sigName: "pmsuspended", callback: Domain.PmsuspendedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "pmsuspended", ...args: any[]): void
    connect(sigName: "resumed", callback: Domain.ResumedSignalCallback): number
    on(sigName: "resumed", callback: Domain.ResumedSignalCallback): number
    once(sigName: "resumed", callback: Domain.ResumedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "resumed", ...args: any[]): void
    connect(sigName: "started", callback: Domain.StartedSignalCallback): number
    on(sigName: "started", callback: Domain.StartedSignalCallback): number
    once(sigName: "started", callback: Domain.StartedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "started", ...args: any[]): void
    connect(sigName: "stopped", callback: Domain.StoppedSignalCallback): number
    on(sigName: "stopped", callback: Domain.StoppedSignalCallback): number
    once(sigName: "stopped", callback: Domain.StoppedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "stopped", ...args: any[]): void
    connect(sigName: "suspended", callback: Domain.SuspendedSignalCallback): number
    on(sigName: "suspended", callback: Domain.SuspendedSignalCallback): number
    once(sigName: "suspended", callback: Domain.SuspendedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "suspended", ...args: any[]): void
    connect(sigName: "updated", callback: Domain.UpdatedSignalCallback): number
    on(sigName: "updated", callback: Domain.UpdatedSignalCallback): number
    once(sigName: "updated", callback: Domain.UpdatedSignalCallback): number
    off(handlerId: number): number
...
export interface Manager {
    ...
    on(sigName: "connection-added", callback: Manager.ConnectionAddedSignalCallback): number
    once(sigName: "connection-added", callback: Manager.ConnectionAddedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "connection-removed", callback: Manager.ConnectionRemovedSignalCallback): number
    once(sigName: "connection-removed", callback: Manager.ConnectionRemovedSignalCallback): number
    off(handlerId: number): number
