...
export function cclosureMarshalGeneric(closure: GObject.TClosure, returnGvalue: any, nParamValues: number, paramValues: any, invocationHint: object | null, marshalData: object | null): void
/**
 ...
 */
export function registeredTypeInfoGetGType(info: RegisteredTypeInfo): GObject.GType
/**
 ...
 * @param arg A #GIArgument to fill in
 */
export function typeTagArgumentFromHashPointer(storageType: TypeTag, hashPointer: object | null, arg: Argument): void
/**
 * GLib data structures, such as #GList, #GSList, and #GHashTable, all store
 * data pointers.
 * In the case where the list or hash table is storing single types rather than
 ...
 */
export function vfuncInfoGetAddress(info: VFuncInfo, implementorGtype: GObject.GType): object | null
/**
