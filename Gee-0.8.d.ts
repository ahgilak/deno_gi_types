...
export function functionsGetEqualFuncFor(t: GObject.GType): [ /* returnType */ EqualDataFunc, /* resultTarget */ object, /* resultTargetDestroyNotify */ GLib.DestroyNotify ]
export function functionsGetHashFuncFor(t: GObject.GType): [ /* returnType */ HashDataFunc, /* resultTarget */ object, /* resultTargetDestroyNotify */ GLib.DestroyNotify ]
export function functionsGetCompareFuncFor(t: GObject.GType): [ /* returnType */ GLib.CompareDataFunc, /* resultTarget */ object, /* resultTargetDestroyNotify */ GLib.DestroyNotify ]
...
export interface BidirSortedMap extends SortedMap {
    ...
    off(handlerId: number): number
    emit(sigName: "notify::read-only-view", ...args: any[]): void
    connect(sigName: "notify::ascending-keys", callback: any): number
    on(sigName: "notify::ascending-keys", callback: any): number
    once(sigName: "notify::ascending-keys", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::ascending-keys", ...args: any[]): void
    connect(sigName: "notify::ascending-entries", callback: any): number
    on(sigName: "notify::ascending-entries", callback: any): number
    once(sigName: "notify::ascending-entries", callback: any): number
    off(handlerId: number): number
...
export interface Collection extends Iterable {
    ...
    // Has conflict: addAllArray(array: object[]): boolean
    // Has conflict: containsAllArray(array: object[]): boolean
    // Has conflict: removeAllArray(array: object[]): boolean
...
export interface Future extends GObject.Object {
    ...
    // Has conflict: waitUntil(endTime: number): [ /* returnType */ boolean, /* value */ object ]
    // Has conflict: waitAsync(callback: Gio.AsyncReadyCallback | null): void
    // Has conflict: waitFinish(res: Gio.AsyncResult): object | null
    ...
    connect(sigName: "notify::exception", callback: any): number
    on(sigName: "notify::exception", callback: any): number
    once(sigName: "notify::exception", callback: any): number
    off(handlerId: number): number
...
export interface Hashable extends GObject.Object {
    ...
    // Has conflict: equalTo(object: object | null): boolean
...
export interface Map extends GObject.Object, Iterable {
    ...
    // Has conflict: unset(key: object | null): [ /* returnType */ boolean, /* value */ object ]
...
export interface MapIterator extends GObject.Object {
    ...
    // Has conflict: fold(aType: GObject.GType, aDupFunc: GObject.BoxedCopyFunc, aDestroyFunc: GLib.DestroyNotify, f: FoldMapFunc, seed: object | null): object | null
...
export interface SortedMap extends Map {
    ...
    // Has conflict: headMap(before: object | null): SortedMap
    // Has conflict: tailMap(after: object | null): SortedMap
    // Has conflict: subMap(before: object | null, after: object | null): SortedMap
...
export interface SortedSet extends Set {
    ...
    // Has conflict: first(): object | null
    // Has conflict: last(): object | null
    // Has conflict: iteratorAt(element: object | null): Iterator | null
...
export interface Traversable extends GObject.Object {
    ...
    // Has conflict: fold(aType: GObject.GType, aDupFunc: GObject.BoxedCopyFunc, aDestroyFunc: GLib.DestroyNotify, f: FoldFunc, seed: object | null): object | null
    // Has conflict: map(aType: GObject.GType, aDupFunc: GObject.BoxedCopyFunc, aDestroyFunc: GLib.DestroyNotify, f: MapFunc): Iterator
    // Has conflict: scan(aType: GObject.GType, aDupFunc: GObject.BoxedCopyFunc, aDestroyFunc: GLib.DestroyNotify, f: FoldFunc, seed: object | null): Iterator
    ...
    // Has conflict: firstMatch(pred: Predicate): object | null
    // Has conflict: anyMatch(pred: Predicate): boolean
    // Has conflict: allMatch(pred: Predicate): boolean
    // Has conflict: max(compare: GLib.CompareDataFunc): object | null
    // Has conflict: min(compare: GLib.CompareDataFunc): object | null
...
export interface AbstractMultiMap extends MultiMap {
    ...
    // Has conflict: getValueEqualFunc(): [ /* returnType */ EqualDataFunc, /* resultTarget */ object, /* resultTargetDestroyNotify */ GLib.DestroyNotify ]
    // Has conflict: reserved0(): void
    // Has conflict: reserved1(): void
    // Has conflict: reserved2(): void
    // Has conflict: reserved3(): void
