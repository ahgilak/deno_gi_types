...
export module VideoSink {
    ...
    export interface ConstructorProperties extends GstVideo.Navigation.ConstructorProperties, GstBase.BaseSink.ConstructorProperties {
...
export interface VideoSink extends GstVideo.Navigation {
