...
export interface Handle {
    ...
    connect(sigName: "notify::dpi-x", callback: any): number
    on(sigName: "notify::dpi-x", callback: any): number
    once(sigName: "notify::dpi-x", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::dpi-x", ...args: any[]): void
    connect(sigName: "notify::dpi-y", callback: any): number
    on(sigName: "notify::dpi-y", callback: any): number
    once(sigName: "notify::dpi-y", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::dpi-y", ...args: any[]): void
    connect(sigName: "notify::em", callback: any): number
    on(sigName: "notify::em", callback: any): number
    once(sigName: "notify::em", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::em", ...args: any[]): void
    connect(sigName: "notify::ex", callback: any): number
    on(sigName: "notify::ex", callback: any): number
    once(sigName: "notify::ex", callback: any): number
    off(handlerId: number): number
