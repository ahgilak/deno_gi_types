...
export interface OAuth2Proxy {
    ...
    connect(sigName: "notify::auth-endpoint", callback: any): number
    on(sigName: "notify::auth-endpoint", callback: any): number
    once(sigName: "notify::auth-endpoint", callback: any): number
    off(handlerId: number): number
...
export interface OAuthProxy {
    ...
    connect(sigName: "notify::signature-host", callback: any): number
    on(sigName: "notify::signature-host", callback: any): number
    once(sigName: "notify::signature-host", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::signature-host", ...args: any[]): void
    connect(sigName: "notify::signature-method", callback: any): number
    on(sigName: "notify::signature-method", callback: any): number
    once(sigName: "notify::signature-method", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::token-secret", callback: any): number
    on(sigName: "notify::token-secret", callback: any): number
    once(sigName: "notify::token-secret", callback: any): number
    off(handlerId: number): number
...
export interface Proxy {
    ...
    on(sigName: "authenticate", callback: Proxy.AuthenticateSignalCallback): number
    once(sigName: "authenticate", callback: Proxy.AuthenticateSignalCallback): number
    off(handlerId: number): number
