...
export interface Client {
    ...
    // Has conflict: connect(cancellable: Gio.Cancellable | null): boolean
    /**
    ...
    on(sigName: "status-changed", callback: Client.StatusChangedSignalCallback): number
    once(sigName: "status-changed", callback: Client.StatusChangedSignalCallback): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::host-machine-id", callback: any): number
    on(sigName: "notify::host-machine-id", callback: any): number
    once(sigName: "notify::host-machine-id", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::host-machine-id", ...args: any[]): void
    connect(sigName: "notify::host-product", callback: any): number
    on(sigName: "notify::host-product", callback: any): number
    once(sigName: "notify::host-product", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::host-product", ...args: any[]): void
    connect(sigName: "notify::host-security-id", callback: any): number
    on(sigName: "notify::host-security-id", callback: any): number
    once(sigName: "notify::host-security-id", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::soup-session", callback: any): number
    on(sigName: "notify::soup-session", callback: any): number
    once(sigName: "notify::soup-session", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::tainted", callback: any): number
    on(sigName: "notify::tainted", callback: any): number
    once(sigName: "notify::tainted", callback: any): number
    off(handlerId: number): number
...
export interface Device {
    ...
    connect(sigName: "notify::version-format", callback: any): number
    on(sigName: "notify::version-format", callback: any): number
    once(sigName: "notify::version-format", callback: any): number
    off(handlerId: number): number
...
export interface Remote {
    ...
    connect(sigName: "notify::approval-required", callback: any): number
    on(sigName: "notify::approval-required", callback: any): number
    once(sigName: "notify::approval-required", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::approval-required", ...args: any[]): void
    connect(sigName: "notify::automatic-reports", callback: any): number
    on(sigName: "notify::automatic-reports", callback: any): number
    once(sigName: "notify::automatic-reports", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::automatic-reports", ...args: any[]): void
    connect(sigName: "notify::automatic-security-reports", callback: any): number
    on(sigName: "notify::automatic-security-reports", callback: any): number
    once(sigName: "notify::automatic-security-reports", callback: any): number
    off(handlerId: number): number
