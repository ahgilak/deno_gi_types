...
export interface Server {
    ...
    on(sigName: "compare-messages", callback: Server.CompareMessagesSignalCallback): number
    once(sigName: "compare-messages", callback: Server.CompareMessagesSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "handle-message", callback: Server.HandleMessageSignalCallback): number
    once(sigName: "handle-message", callback: Server.HandleMessageSignalCallback): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::enable-logging", callback: any): number
    on(sigName: "notify::enable-logging", callback: any): number
    once(sigName: "notify::enable-logging", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::enable-logging", ...args: any[]): void
    connect(sigName: "notify::enable-online", callback: any): number
    on(sigName: "notify::enable-online", callback: any): number
    once(sigName: "notify::enable-online", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::resolver", callback: any): number
    on(sigName: "notify::resolver", callback: any): number
    once(sigName: "notify::resolver", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::trace-directory", callback: any): number
    on(sigName: "notify::trace-directory", callback: any): number
    once(sigName: "notify::trace-directory", callback: any): number
    off(handlerId: number): number
