...
import type * as DBus from './DBus-1.0.js';
...
export interface Accessible extends Action, Collection, Component, Document, EditableText, Hypertext, Image, Selection, Table, TableCell, Text, Value {
    ...
    on(sigName: "mode-changed", callback: Accessible.ModeChangedSignalCallback): number
    once(sigName: "mode-changed", callback: Accessible.ModeChangedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "region-changed", callback: Accessible.RegionChangedSignalCallback): number
    once(sigName: "region-changed", callback: Accessible.RegionChangedSignalCallback): number
    off(handlerId: number): number
