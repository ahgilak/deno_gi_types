...
export interface Component {
    ...
    connect(sigName: "notify::developer-name", callback: any): number
    on(sigName: "notify::developer-name", callback: any): number
    once(sigName: "notify::developer-name", callback: any): number
    off(handlerId: number): number
    ...
    off(handlerId: number): number
    emit(sigName: "notify::name", ...args: any[]): void
    connect(sigName: "notify::pkgnames", callback: any): number
    on(sigName: "notify::pkgnames", callback: any): number
    once(sigName: "notify::pkgnames", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::pkgnames", ...args: any[]): void
    connect(sigName: "notify::project-group", callback: any): number
    on(sigName: "notify::project-group", callback: any): number
    once(sigName: "notify::project-group", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::project-group", ...args: any[]): void
    connect(sigName: "notify::project-license", callback: any): number
    on(sigName: "notify::project-license", callback: any): number
    once(sigName: "notify::project-license", callback: any): number
    off(handlerId: number): number
...
export interface Pool {
    ...
    on(sigName: "changed", callback: Pool.ChangedSignalCallback): number
    once(sigName: "changed", callback: Pool.ChangedSignalCallback): number
    off(handlerId: number): number
...
export interface Review {
    ...
    connect(sigName: "notify::reviewer-id", callback: any): number
    on(sigName: "notify::reviewer-id", callback: any): number
    once(sigName: "notify::reviewer-id", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::reviewer-id", ...args: any[]): void
    connect(sigName: "notify::reviewer-name", callback: any): number
    on(sigName: "notify::reviewer-name", callback: any): number
    once(sigName: "notify::reviewer-name", callback: any): number
    off(handlerId: number): number
...
export interface DistroDetailsClass {
