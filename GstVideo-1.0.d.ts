...
export interface VideoDirection {
    ...
    connect(sigName: "notify::video-direction", callback: any): number
    on(sigName: "notify::video-direction", callback: any): number
    once(sigName: "notify::video-direction", callback: any): number
    off(handlerId: number): number
...
export interface VideoAggregatorConvertPad {
    ...
    connect(sigName: "notify::max-last-buffer-repeat", callback: any): number
    on(sigName: "notify::max-last-buffer-repeat", callback: any): number
    once(sigName: "notify::max-last-buffer-repeat", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::max-last-buffer-repeat", ...args: any[]): void
    connect(sigName: "notify::repeat-after-eos", callback: any): number
    on(sigName: "notify::repeat-after-eos", callback: any): number
    once(sigName: "notify::repeat-after-eos", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::repeat-after-eos", ...args: any[]): void
    connect(sigName: "notify::zorder", callback: any): number
    on(sigName: "notify::zorder", callback: any): number
    once(sigName: "notify::zorder", callback: any): number
    off(handlerId: number): number
...
export interface VideoDecoder {
    ...
    connect(sigName: "notify::automatic-request-sync-point-flags", callback: any): number
    on(sigName: "notify::automatic-request-sync-point-flags", callback: any): number
    once(sigName: "notify::automatic-request-sync-point-flags", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::automatic-request-sync-point-flags", ...args: any[]): void
    connect(sigName: "notify::automatic-request-sync-points", callback: any): number
    on(sigName: "notify::automatic-request-sync-points", callback: any): number
    once(sigName: "notify::automatic-request-sync-points", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::automatic-request-sync-points", ...args: any[]): void
    connect(sigName: "notify::discard-corrupted-frames", callback: any): number
    on(sigName: "notify::discard-corrupted-frames", callback: any): number
    once(sigName: "notify::discard-corrupted-frames", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::min-force-key-unit-interval", callback: any): number
    on(sigName: "notify::min-force-key-unit-interval", callback: any): number
    once(sigName: "notify::min-force-key-unit-interval", callback: any): number
    off(handlerId: number): number
