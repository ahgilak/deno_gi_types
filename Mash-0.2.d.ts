...
export interface DirectionalLight extends Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
    ...
    connect(sigName: "notify::ambient", callback: any): number
    on(sigName: "notify::ambient", callback: any): number
    once(sigName: "notify::ambient", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::ambient", ...args: any[]): void
    connect(sigName: "notify::diffuse", callback: any): number
    on(sigName: "notify::diffuse", callback: any): number
    once(sigName: "notify::diffuse", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::diffuse", ...args: any[]): void
    connect(sigName: "notify::specular", callback: any): number
    on(sigName: "notify::specular", callback: any): number
    once(sigName: "notify::specular", callback: any): number
    off(handlerId: number): number
...
export interface Model extends Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
    ...
    connect(sigName: "notify::fit-to-allocation", callback: any): number
    on(sigName: "notify::fit-to-allocation", callback: any): number
    once(sigName: "notify::fit-to-allocation", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::fit-to-allocation", ...args: any[]): void
    connect(sigName: "notify::light-set", callback: any): number
    on(sigName: "notify::light-set", callback: any): number
    once(sigName: "notify::light-set", callback: any): number
    off(handlerId: number): number
...
export interface PointLight extends Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
    ...
    connect(sigName: "notify::constant-attenuation", callback: any): number
    on(sigName: "notify::constant-attenuation", callback: any): number
    once(sigName: "notify::constant-attenuation", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::constant-attenuation", ...args: any[]): void
    connect(sigName: "notify::linear-attenuation", callback: any): number
    on(sigName: "notify::linear-attenuation", callback: any): number
    once(sigName: "notify::linear-attenuation", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::linear-attenuation", ...args: any[]): void
    connect(sigName: "notify::quadratic-attenuation", callback: any): number
    on(sigName: "notify::quadratic-attenuation", callback: any): number
    once(sigName: "notify::quadratic-attenuation", callback: any): number
    off(handlerId: number): number
...
export interface SpotLight extends Atk.ImplementorIface, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
    ...
    connect(sigName: "notify::spot-cutoff", callback: any): number
    on(sigName: "notify::spot-cutoff", callback: any): number
    once(sigName: "notify::spot-cutoff", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::spot-cutoff", ...args: any[]): void
    connect(sigName: "notify::spot-exponent", callback: any): number
    on(sigName: "notify::spot-exponent", callback: any): number
    once(sigName: "notify::spot-exponent", callback: any): number
    off(handlerId: number): number
