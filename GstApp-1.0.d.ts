...
export interface AppSink extends Gst.URIHandler {
    ...
    on(sigName: "eos", callback: AppSink.EosSignalCallback): number
    once(sigName: "eos", callback: AppSink.EosSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "eos", ...args: any[]): void
    connect(sigName: "new-preroll", callback: AppSink.NewPrerollSignalCallback): number
    on(sigName: "new-preroll", callback: AppSink.NewPrerollSignalCallback): number
    once(sigName: "new-preroll", callback: AppSink.NewPrerollSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "new-preroll", ...args: any[]): void
    connect(sigName: "new-sample", callback: AppSink.NewSampleSignalCallback): number
    on(sigName: "new-sample", callback: AppSink.NewSampleSignalCallback): number
    once(sigName: "new-sample", callback: AppSink.NewSampleSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "new-serialized-event", callback: AppSink.NewSerializedEventSignalCallback): number
    once(sigName: "new-serialized-event", callback: AppSink.NewSerializedEventSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "pull-preroll", callback: AppSink.PullPrerollSignalCallback): number
    once(sigName: "pull-preroll", callback: AppSink.PullPrerollSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "pull-preroll", ...args: any[]): void
    connect(sigName: "pull-sample", callback: AppSink.PullSampleSignalCallback): number
    on(sigName: "pull-sample", callback: AppSink.PullSampleSignalCallback): number
    once(sigName: "pull-sample", callback: AppSink.PullSampleSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "try-pull-object", callback: AppSink.TryPullObjectSignalCallback): number
    once(sigName: "try-pull-object", callback: AppSink.TryPullObjectSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "try-pull-preroll", callback: AppSink.TryPullPrerollSignalCallback): number
    once(sigName: "try-pull-preroll", callback: AppSink.TryPullPrerollSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "try-pull-sample", callback: AppSink.TryPullSampleSignalCallback): number
    once(sigName: "try-pull-sample", callback: AppSink.TryPullSampleSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "try-pull-sample", ...args: any[]): void

    // Class property signals of GstApp-1.0.GstApp.AppSink

    connect(sigName: "notify::buffer-list", callback: any): number
    on(sigName: "notify::buffer-list", callback: any): number
    once(sigName: "notify::buffer-list", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::drop", callback: any): number
    on(sigName: "notify::drop", callback: any): number
    once(sigName: "notify::drop", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::drop", ...args: any[]): void
    connect(sigName: "notify::emit-signals", callback: any): number
    on(sigName: "notify::emit-signals", callback: any): number
    once(sigName: "notify::emit-signals", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::emit-signals", ...args: any[]): void
    connect(sigName: "notify::eos", callback: any): number
    on(sigName: "notify::eos", callback: any): number
    once(sigName: "notify::eos", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::eos", ...args: any[]): void
    connect(sigName: "notify::max-buffers", callback: any): number
    on(sigName: "notify::max-buffers", callback: any): number
    once(sigName: "notify::max-buffers", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::max-buffers", ...args: any[]): void
    connect(sigName: "notify::wait-on-eos", callback: any): number
    on(sigName: "notify::wait-on-eos", callback: any): number
    once(sigName: "notify::wait-on-eos", callback: any): number
    off(handlerId: number): number
...
export interface AppSrc extends Gst.URIHandler {
    ...
    on(sigName: "end-of-stream", callback: AppSrc.EndOfStreamSignalCallback): number
    once(sigName: "end-of-stream", callback: AppSrc.EndOfStreamSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "end-of-stream", ...args: any[]): void
    connect(sigName: "enough-data", callback: AppSrc.EnoughDataSignalCallback): number
    on(sigName: "enough-data", callback: AppSrc.EnoughDataSignalCallback): number
    once(sigName: "enough-data", callback: AppSrc.EnoughDataSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "enough-data", ...args: any[]): void
    connect(sigName: "need-data", callback: AppSrc.NeedDataSignalCallback): number
    on(sigName: "need-data", callback: AppSrc.NeedDataSignalCallback): number
    once(sigName: "need-data", callback: AppSrc.NeedDataSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "need-data", ...args: any[]): void
    connect(sigName: "push-buffer", callback: AppSrc.PushBufferSignalCallback): number
    on(sigName: "push-buffer", callback: AppSrc.PushBufferSignalCallback): number
    once(sigName: "push-buffer", callback: AppSrc.PushBufferSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "push-buffer-list", callback: AppSrc.PushBufferListSignalCallback): number
    once(sigName: "push-buffer-list", callback: AppSrc.PushBufferListSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "push-buffer-list", ...args: any[]): void
    connect(sigName: "push-sample", callback: AppSrc.PushSampleSignalCallback): number
    on(sigName: "push-sample", callback: AppSrc.PushSampleSignalCallback): number
    once(sigName: "push-sample", callback: AppSrc.PushSampleSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "push-sample", ...args: any[]): void
    connect(sigName: "seek-data", callback: AppSrc.SeekDataSignalCallback): number
    on(sigName: "seek-data", callback: AppSrc.SeekDataSignalCallback): number
    once(sigName: "seek-data", callback: AppSrc.SeekDataSignalCallback): number
    off(handlerId: number): number
    ...
    off(handlerId: number): number
    emit(sigName: "notify::caps", ...args: any[]): void
    connect(sigName: "notify::current-level-buffers", callback: any): number
    on(sigName: "notify::current-level-buffers", callback: any): number
    once(sigName: "notify::current-level-buffers", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::handle-segment-change", callback: any): number
    on(sigName: "notify::handle-segment-change", callback: any): number
    once(sigName: "notify::handle-segment-change", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::handle-segment-change", ...args: any[]): void
    connect(sigName: "notify::is-live", callback: any): number
    on(sigName: "notify::is-live", callback: any): number
    once(sigName: "notify::is-live", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::is-live", ...args: any[]): void
    connect(sigName: "notify::leaky-type", callback: any): number
    on(sigName: "notify::leaky-type", callback: any): number
    once(sigName: "notify::leaky-type", callback: any): number
    off(handlerId: number): number
    ...
    off(handlerId: number): number
    emit(sigName: "notify::max-buffers", ...args: any[]): void
    connect(sigName: "notify::max-bytes", callback: any): number
    on(sigName: "notify::max-bytes", callback: any): number
    once(sigName: "notify::max-bytes", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::max-bytes", ...args: any[]): void
    connect(sigName: "notify::max-latency", callback: any): number
    on(sigName: "notify::max-latency", callback: any): number
    once(sigName: "notify::max-latency", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::max-latency", ...args: any[]): void
    connect(sigName: "notify::max-time", callback: any): number
    on(sigName: "notify::max-time", callback: any): number
    once(sigName: "notify::max-time", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::min-percent", callback: any): number
    on(sigName: "notify::min-percent", callback: any): number
    once(sigName: "notify::min-percent", callback: any): number
    off(handlerId: number): number
