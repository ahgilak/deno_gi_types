...
export interface MinerManager extends Gio.Initable {
    ...
    connect(sigName: "notify::domain-ontology", callback: any): number
    on(sigName: "notify::domain-ontology", callback: any): number
    once(sigName: "notify::domain-ontology", callback: any): number
    off(handlerId: number): number
