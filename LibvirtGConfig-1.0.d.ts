...
export interface Domain {
    ...
    connect(sigName: "notify::current-memory", callback: any): number
    on(sigName: "notify::current-memory", callback: any): number
    once(sigName: "notify::current-memory", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::vcpu", callback: any): number
    on(sigName: "notify::vcpu", callback: any): number
    once(sigName: "notify::vcpu", callback: any): number
    off(handlerId: number): number
