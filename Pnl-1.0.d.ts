...
export interface DockItem extends Gtk.Widget {
    ...
    on(sigName: "manager-set", callback: DockItem.ManagerSetSignalCallback): number
    once(sigName: "manager-set", callback: DockItem.ManagerSetSignalCallback): number
    off(handlerId: number): number
...
export interface DockBinEdge extends Atk.ImplementorIface, Gtk.Buildable, DockItem {
    ...
    on(sigName: "move-to-bin-child", callback: DockBinEdge.MoveToBinChildSignalCallback): number
    once(sigName: "move-to-bin-child", callback: DockBinEdge.MoveToBinChildSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "move-to-bin-child", ...args: any[]): void

    // Class property signals of Pnl-1.0.Pnl.DockBinEdge

    connect(sigName: "notify::edge", callback: any): number
    on(sigName: "notify::edge", callback: any): number
    once(sigName: "notify::edge", callback: any): number
    off(handlerId: number): number
...
export interface DockManager {
    ...
    on(sigName: "register-dock", callback: DockManager.RegisterDockSignalCallback): number
    once(sigName: "register-dock", callback: DockManager.RegisterDockSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "unregister-dock", callback: DockManager.UnregisterDockSignalCallback): number
    once(sigName: "unregister-dock", callback: DockManager.UnregisterDockSignalCallback): number
    off(handlerId: number): number
...
export interface DockOverlay extends Atk.ImplementorIface, Gtk.Buildable, Dock, DockItem {
    ...
    on(sigName: "hide-edges", callback: DockOverlay.HideEdgesSignalCallback): number
    once(sigName: "hide-edges", callback: DockOverlay.HideEdgesSignalCallback): number
    off(handlerId: number): number
...
export interface MultiPaned extends Atk.ImplementorIface, Gtk.Buildable, Gtk.Orientable {
    ...
    on(sigName: "resize-drag-begin", callback: MultiPaned.ResizeDragBeginSignalCallback): number
    once(sigName: "resize-drag-begin", callback: MultiPaned.ResizeDragBeginSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "resize-drag-end", callback: MultiPaned.ResizeDragEndSignalCallback): number
    once(sigName: "resize-drag-end", callback: MultiPaned.ResizeDragEndSignalCallback): number
    off(handlerId: number): number
