...
export interface Authority extends Gio.AsyncInitable, Gio.Initable {
    ...
    on(sigName: "changed", callback: Authority.ChangedSignalCallback): number
    once(sigName: "changed", callback: Authority.ChangedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "changed", ...args: any[]): void

    // Class property signals of Polkit-1.0.Polkit.Authority

    connect(sigName: "notify::backend-features", callback: any): number
    on(sigName: "notify::backend-features", callback: any): number
    once(sigName: "notify::backend-features", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::backend-version", callback: any): number
    on(sigName: "notify::backend-version", callback: any): number
    once(sigName: "notify::backend-version", callback: any): number
    off(handlerId: number): number
...
export interface Permission extends Gio.AsyncInitable, Gio.Initable {
    ...
    connect(sigName: "notify::action-id", callback: any): number
    on(sigName: "notify::action-id", callback: any): number
    once(sigName: "notify::action-id", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::allowed", callback: any): number
    on(sigName: "notify::allowed", callback: any): number
    once(sigName: "notify::allowed", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::allowed", ...args: any[]): void
    connect(sigName: "notify::can-acquire", callback: any): number
    on(sigName: "notify::can-acquire", callback: any): number
    once(sigName: "notify::can-acquire", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::can-acquire", ...args: any[]): void
    connect(sigName: "notify::can-release", callback: any): number
    on(sigName: "notify::can-release", callback: any): number
    once(sigName: "notify::can-release", callback: any): number
    off(handlerId: number): number
...
export interface UnixGroup extends Identity {
    ...
    connect(sigName: "notify::gid", callback: any): number
    on(sigName: "notify::gid", callback: any): number
    once(sigName: "notify::gid", callback: any): number
    off(handlerId: number): number
...
export interface UnixProcess extends Subject {
    ...
    connect(sigName: "notify::pid", callback: any): number
    on(sigName: "notify::pid", callback: any): number
    once(sigName: "notify::pid", callback: any): number
    off(handlerId: number): number
