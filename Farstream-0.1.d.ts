...
export interface Stream {
    ...
    // Has conflict: setTransmitter(transmitter: string, streamTransmitterParameters: GObject.Parameter, streamTransmitterNParameters: number): boolean
...
export interface Transmitter {
    ...
    on(sigName: "get-recvonly-filter", callback: Transmitter.GetRecvonlyFilterSignalCallback): number
    once(sigName: "get-recvonly-filter", callback: Transmitter.GetRecvonlyFilterSignalCallback): number
    off(handlerId: number): number
