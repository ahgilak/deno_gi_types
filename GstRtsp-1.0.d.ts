...
export interface RTSPExtension {
    ...
    // Has conflict: getTransports(protocols: RTSPLowerTrans, transport: string): RTSPResult
    ...
    on(sigName: "send", callback: RTSPExtension.SendSignalCallback): number
    once(sigName: "send", callback: RTSPExtension.SendSignalCallback): number
