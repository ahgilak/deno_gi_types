 ...
 */
export function bufferAddLatin1(buffer: buffer_t, text: Uint8Array, itemOffset: number, itemLength: number): void
/**
 ...
 * @param itemLength the number of characters to add to the `buffer,` or -1 for the               end of `text` (assuming it is %NULL terminated).
 */
export function bufferAddUtf8(buffer: buffer_t, text: Uint8Array, itemOffset: number, itemLength: number): void
/**
 ...
 */
export function bufferSerialize(buffer: buffer_t, start: number, end: number, font: font_t | null, format: buffer_serialize_format_t, flags: buffer_serialize_flags_t): [ /* returnType */ number, /* buf */ Uint8Array, /* bufConsumed */ number ]
/**
 ...
 */
export function bufferSerializeFormatFromString(str: Uint8Array): buffer_serialize_format_t
/**
 ...
 * @param flags the #hb_buffer_serialize_flags_t that control what glyph properties         to serialize.
 */
export function bufferSerializeGlyphs(buffer: buffer_t, start: number, end: number, font: font_t | null, format: buffer_serialize_format_t, flags: buffer_serialize_flags_t): [ /* returnType */ number, /* buf */ Uint8Array, /* bufConsumed */ number ]
/**
 ...
 * @param flags 
 */
export function bufferSerializeUnicode(buffer: buffer_t, start: number, end: number, format: buffer_serialize_format_t, flags: buffer_serialize_flags_t): [ /* returnType */ number, /* buf */ Uint8Array, /* bufConsumed */ number ]
...
export function directionFromString(str: Uint8Array): direction_t
 ...
 * @param str a string to parse
 */
export function featureFromString(str: Uint8Array): [ /* returnType */ bool_t, /* feature */ feature_t ]
/**
...
export function fontGlyphFromString(font: font_t, s: Uint8Array): [ /* returnType */ bool_t, /* glyph */ codepoint_t ]
 ...
 */
export function languageFromString(str: Uint8Array): language_t
/**
 ...
 * @param featureIndex index of feature to query.
 */
export function otLayoutFeatureGetNameIds(face: face_t, tableTag: tag_t, featureIndex: number): [ /* returnType */ bool_t, /* labelId */ ot_name_id_t, /* tooltipId */ ot_name_id_t, /* sampleId */ ot_name_id_t, /* numNamedParameters */ number, /* firstParamId */ ot_name_id_t ]
/**
 * Fetches a list of all lookups enumerated for the specified feature, in
 ...
 */
export function otMetricsGetPosition(font: font_t, metricsTag: ot_metrics_tag_t): [ /* returnType */ bool_t, /* position */ position_t ]
 ...
 */
export function otTagsFromScriptAndLanguage(script: script_t, language: language_t, scriptCount: number | null, languageCount: number | null): [ /* scriptTags */ tag_t, /* languageTags */ tag_t ]
/**
 ...
 */
export function scriptFromString(str: Uint8Array): script_t
...
export function tagFromString(str: Uint8Array): tag_t
export function tagToString(tag: tag_t): /* buf */ Uint8Array
/**
