...
export function checksumB64FromBytes(csum: Uint8Array): string
export function checksumB64ToBytes(checksum: string): Uint8Array
...
export function checksumFromBytes(csum: Uint8Array): string
...
export function checksumToBytes(checksum: string): Uint8Array
 ...
 */
export function parseRefspec(refspec: string): [ /* returnType */ boolean, /* outRemote */ string, /* outRef */ string ]
/**
...
export interface AsyncProgress {
    ...
    on(sigName: "changed", callback: AsyncProgress.ChangedSignalCallback): number
    once(sigName: "changed", callback: AsyncProgress.ChangedSignalCallback): number
...
export interface Repo {
    ...
    on(sigName: "gpg-verify-result", callback: Repo.GpgVerifyResultSignalCallback): number
    once(sigName: "gpg-verify-result", callback: Repo.GpgVerifyResultSignalCallback): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::remotes-config-dir", callback: any): number
    on(sigName: "notify::remotes-config-dir", callback: any): number
    once(sigName: "notify::remotes-config-dir", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::remotes-config-dir", ...args: any[]): void
    connect(sigName: "notify::sysroot-path", callback: any): number
    on(sigName: "notify::sysroot-path", callback: any): number
    once(sigName: "notify::sysroot-path", callback: any): number
    off(handlerId: number): number
...
export interface SysrootUpgrader extends Gio.Initable {
    ...
    connect(sigName: "notify::osname", callback: any): number
    on(sigName: "notify::osname", callback: any): number
    once(sigName: "notify::osname", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::osname", ...args: any[]): void
    connect(sigName: "notify::sysroot", callback: any): number
    on(sigName: "notify::sysroot", callback: any): number
    once(sigName: "notify::sysroot", callback: any): number
    off(handlerId: number): number
