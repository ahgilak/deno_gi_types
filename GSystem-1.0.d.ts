 ...
 * @param cancellable a #GCancellable
 */
export function fileCreate(file: Gio.File, mode: number, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outStream */ Gio.OutputStream ]
/**
 ...
 * @param cancellable a #GCancellable
 */
export function fileEnumeratorIterate(direnum: Gio.FileEnumerator, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outInfo */ Gio.FileInfo, /* outChild */ Gio.File ]
/**
 ...
 * @param cancellable 
 */
export function fileOpenInTmpdir(tmpdir: Gio.File, mode: number, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outFile */ Gio.File, /* outStream */ Gio.OutputStream ]
/**
 * Like g_file_open_tmp(), except the file will be created in the
 * provided `tmpdir,` and allows specification of the Unix `mode,` which
 * means private files may be created.  Return values will be stored
 ...
 * @param cancellable 
 */
export function fileOpenInTmpdirAt(tmpdirFd: number, mode: number, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outName */ string, /* outStream */ Gio.OutputStream ]
/**
 ...
 * @class 
 */
export class Console extends GObject.Object {
...
export interface Subprocess extends Gio.Initable {
...
export module SubprocessContext {
...
export interface SubprocessContext {
    ...
    connect(sigName: "notify::argv", callback: any): number
    on(sigName: "notify::argv", callback: any): number
    once(sigName: "notify::argv", callback: any): number
    off(handlerId: number): number
 ...
 * @class 
 */
export class SubprocessContext extends GObject.Object {
...
export interface DirFdIterator {
