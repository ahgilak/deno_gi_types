...
export function marshalVOIDBOXEDENUMBOOLEAN(closure: GObject.TClosure, returnValue: any, nParamValues: number, paramValues: any, invocationHint: object, marshalData: object): void
/**
...
export interface MediaSource {
    ...
    // Has conflict: query(query: string, keys: GObject.ParamSpec[], skip: number, count: number, flags: MetadataResolutionFlags, callback: MediaSourceResultCb): number
    /**
    ...
    // Has conflict: search(text: string, keys: GObject.ParamSpec[], skip: number, count: number, flags: MetadataResolutionFlags, callback: MediaSourceResultCb): number
    /**
    ...
    on(sigName: "content-changed", callback: MediaSource.ContentChangedSignalCallback): number
    once(sigName: "content-changed", callback: MediaSource.ContentChangedSignalCallback): number
    off(handlerId: number): number
...
export interface PluginRegistry {
    ...
    on(sigName: "source-added", callback: PluginRegistry.SourceAddedSignalCallback): number
    once(sigName: "source-added", callback: PluginRegistry.SourceAddedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "source-removed", callback: PluginRegistry.SourceRemovedSignalCallback): number
    once(sigName: "source-removed", callback: PluginRegistry.SourceRemovedSignalCallback): number
    off(handlerId: number): number
