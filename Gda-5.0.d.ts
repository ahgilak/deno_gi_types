...
export interface Connection extends Lockable {
    ...
    on(sigName: "conn-closed", callback: Connection.ConnClosedSignalCallback): number
    once(sigName: "conn-closed", callback: Connection.ConnClosedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "conn-closed", ...args: any[]): void
    connect(sigName: "conn-opened", callback: Connection.ConnOpenedSignalCallback): number
    on(sigName: "conn-opened", callback: Connection.ConnOpenedSignalCallback): number
    once(sigName: "conn-opened", callback: Connection.ConnOpenedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "conn-opened", ...args: any[]): void
    connect(sigName: "conn-to-close", callback: Connection.ConnToCloseSignalCallback): number
    on(sigName: "conn-to-close", callback: Connection.ConnToCloseSignalCallback): number
    once(sigName: "conn-to-close", callback: Connection.ConnToCloseSignalCallback): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::is-wrapper", callback: any): number
    on(sigName: "notify::is-wrapper", callback: any): number
    once(sigName: "notify::is-wrapper", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::monitor-wrapped-in-mainloop", callback: any): number
    on(sigName: "notify::monitor-wrapped-in-mainloop", callback: any): number
    once(sigName: "notify::monitor-wrapped-in-mainloop", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::thread-owner", callback: any): number
    on(sigName: "notify::thread-owner", callback: any): number
    once(sigName: "notify::thread-owner", callback: any): number
    off(handlerId: number): number
...
export interface DataModelIter {
    ...
    connect(sigName: "notify::forced-model", callback: any): number
    on(sigName: "notify::forced-model", callback: any): number
    once(sigName: "notify::forced-model", callback: any): number
    off(handlerId: number): number
...
export interface Holder extends Lockable {
    ...
    on(sigName: "attribute-changed", callback: Holder.AttributeChangedSignalCallback): number
    once(sigName: "attribute-changed", callback: Holder.AttributeChangedSignalCallback): number
    off(handlerId: number): number
...
export interface ServerProvider {
    ...
    // Has conflict: escapeString(cnc: Connection | null, str: string): string
    /**
    ...
    // Has conflict: unescapeString(cnc: Connection | null, str: string): string
    /**
     * Produces a fully quoted and escaped string from a GValue
     * @param cnc a #GdaConnection object, or %NULL
     * @param from #GValue to convert from
    ...
    identifierQuote(cnc: Connection, id: string, forMetaStore: boolean, forceQuotes: boolean): string
...
export interface TreeMgrLdap {
    ...
    connect(sigName: "notify::dn", callback: any): number
    on(sigName: "notify::dn", callback: any): number
    once(sigName: "notify::dn", callback: any): number
    off(handlerId: number): number
