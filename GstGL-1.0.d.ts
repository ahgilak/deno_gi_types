...
export interface GLBaseMemoryAllocator {
    ...
    alloc(params: GLAllocationParams): GLBaseMemory
...
export interface GLContext {
    ...
    // Has conflict: getGlContext(): number
...
export interface GLDisplay {
    ...
    // Has conflict: createWindow(): GLWindow
    /**
    ...
    on(sigName: "create-context", callback: GLDisplay.CreateContextSignalCallback): number
    once(sigName: "create-context", callback: GLDisplay.CreateContextSignalCallback): number
    off(handlerId: number): number
...
export interface GLOverlayCompositor {
    ...
    connect(sigName: "notify::yinvert", callback: any): number
    on(sigName: "notify::yinvert", callback: any): number
    once(sigName: "notify::yinvert", callback: any): number
    off(handlerId: number): number
...
export interface GLShader {
    ...
    connect(sigName: "notify::linked", callback: any): number
    on(sigName: "notify::linked", callback: any): number
    once(sigName: "notify::linked", callback: any): number
    off(handlerId: number): number
...
export interface GLWindow {
    ...
    // Has conflict: getDisplay(): number
    getSurfaceDimensions(): [ /* width */ number, /* height */ number ]
    // Has conflict: getWindowHandle(): number
    ...
    on(sigName: "key-event", callback: GLWindow.KeyEventSignalCallback): number
    once(sigName: "key-event", callback: GLWindow.KeyEventSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "mouse-event", callback: GLWindow.MouseEventSignalCallback): number
    once(sigName: "mouse-event", callback: GLWindow.MouseEventSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "scroll-event", callback: GLWindow.ScrollEventSignalCallback): number
    once(sigName: "scroll-event", callback: GLWindow.ScrollEventSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "window-handle-changed", callback: GLWindow.WindowHandleChangedSignalCallback): number
    once(sigName: "window-handle-changed", callback: GLWindow.WindowHandleChangedSignalCallback): number
    off(handlerId: number): number
