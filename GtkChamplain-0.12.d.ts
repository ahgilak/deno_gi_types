...
export interface Embed extends Atk.ImplementorIface, Gtk.Buildable {
    ...
    connect(sigName: "notify::champlain-view", callback: any): number
    on(sigName: "notify::champlain-view", callback: any): number
    once(sigName: "notify::champlain-view", callback: any): number
    ...
    connect(sigName: "notify::xscale", callback: any): number
    on(sigName: "notify::xscale", callback: any): number
    once(sigName: "notify::xscale", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::yscale", callback: any): number
    on(sigName: "notify::yscale", callback: any): number
    once(sigName: "notify::yscale", callback: any): number
    off(handlerId: number): number
