...
import type * as EBackend from './EBackend-1.2.js';
...
export interface CalBackend extends ECal.TimezoneCache {
    ...
    implAddTimezone(cal: DataCal, opid: number, cancellable: Gio.Cancellable | null, tzobject: string): void
    implDiscardAlarm(cal: DataCal, opid: number, cancellable: Gio.Cancellable | null, uid: string, rid: string, auid: string, opflags: ECal.OperationFlags): void
    implGetAttachmentUris(cal: DataCal, opid: number, cancellable: Gio.Cancellable | null, uid: string, rid: string): void
    implGetBackendProperty(propName: string): string
    implGetObject(cal: DataCal, opid: number, cancellable: Gio.Cancellable | null, uid: string, rid: string): void
    implGetObjectList(cal: DataCal, opid: number, cancellable: Gio.Cancellable | null, sexp: string): void
    implGetTimezone(cal: DataCal, opid: number, cancellable: Gio.Cancellable | null, tzid: string): void
    implOpen(cal: DataCal, opid: number, cancellable: Gio.Cancellable | null): void
    implReceiveObjects(cal: DataCal, opid: number, cancellable: Gio.Cancellable | null, calobj: string, opflags: ECal.OperationFlags): void
    implRefresh(cal: DataCal, opid: number, cancellable: Gio.Cancellable | null): void
    implSendObjects(cal: DataCal, opid: number, cancellable: Gio.Cancellable | null, calobj: string, opflags: ECal.OperationFlags): void
    ...
    on(sigName: "closed", callback: CalBackend.ClosedSignalCallback): number
    once(sigName: "closed", callback: CalBackend.ClosedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "closed", ...args: any[]): void
    connect(sigName: "shutdown", callback: CalBackend.ShutdownSignalCallback): number
    on(sigName: "shutdown", callback: CalBackend.ShutdownSignalCallback): number
    once(sigName: "shutdown", callback: CalBackend.ShutdownSignalCallback): number
    off(handlerId: number): number
...
export interface CalBackendSync extends ECal.TimezoneCache {
    ...
    addTimezoneSync(cal: DataCal, cancellable: Gio.Cancellable | null, tzobject: string): void
     ...
     */
    addTimezoneSync(tzobject: string, cancellable: Gio.Cancellable | null): boolean
    discardAlarmSync(cal: DataCal, cancellable: Gio.Cancellable | null, uid: string, rid: string, auid: string, opflags: ECal.OperationFlags): void
     ...
     */
    discardAlarmSync(uid: string, rid: string | null, alarmUid: string, opflags: ECal.OperationFlags, cancellable: Gio.Cancellable | null): boolean
    getObjectSync(cal: DataCal, cancellable: Gio.Cancellable | null, uid: string, rid: string, calobj: string): void
     ...
     */
    getObjectSync(uid: string, rid: string | null, cancellable: Gio.Cancellable | null): string
    getTimezoneSync(cal: DataCal, cancellable: Gio.Cancellable | null, tzid: string, tzobject: string): void
     ...
     */
    openSync(cancellable: Gio.Cancellable | null): boolean
    receiveObjectsSync(cal: DataCal, cancellable: Gio.Cancellable | null, calobj: string, opflags: ECal.OperationFlags): void
...
export interface CalCache extends ECal.TimezoneCache, EDataServer.Extensible {
    ...
    // Has conflict: dupComponentRevision(icomp: ICalGLib.Component): string
    /**
    ...
    on(sigName: "dup-component-revision", callback: CalCache.DupComponentRevisionSignalCallback): number
    once(sigName: "dup-component-revision", callback: CalCache.DupComponentRevisionSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "get-timezone", callback: CalCache.GetTimezoneSignalCallback): number
    once(sigName: "get-timezone", callback: CalCache.GetTimezoneSignalCallback): number
    off(handlerId: number): number
...
export interface CalMetaBackend extends ECal.TimezoneCache {
    ...
    // Has conflict: connectSync(credentials: EDataServer.NamedParameters | null, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outAuthResult */ EDataServer.SourceAuthenticationResult, /* outCertificatePem */ string, /* outCertificateErrors */ Gio.TlsCertificateFlags ]
    ...
    // Has conflict: getChangesSync(lastSyncTag: string | null, isRepeat: boolean, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outNewSyncTag */ string, /* outRepeat */ boolean, /* outCreatedObjects */ CalMetaBackendInfo[], /* outModifiedObjects */ CalMetaBackendInfo[], /* outRemovedObjects */ CalMetaBackendInfo[] ]
    /**
    ...
    // Has conflict: getSslErrorDetails(): [ /* returnType */ boolean, /* outCertificatePem */ string, /* outCertificateErrors */ Gio.TlsCertificateFlags ]
    /**
    ...
    // Has conflict: listExistingSync(cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outNewSyncTag */ string, /* outExistingObjects */ CalMetaBackendInfo[] ]
    // Has conflict: loadComponentSync(uid: string, extra: string | null, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outComponent */ ICalGLib.Component, /* outExtra */ string ]
    /**
     ...
     */
    refreshSync(cancellable: Gio.Cancellable | null): boolean
    // Has conflict: removeComponentSync(conflictResolution: EDataServer.ConflictResolution, uid: string, extra: string | null, object: string | null, opflags: ECal.OperationFlags, cancellable: Gio.Cancellable | null): boolean
    // Has conflict: requiresReconnect(): boolean
    // Has conflict: saveComponentSync(overwriteExisting: boolean, conflictResolution: EDataServer.ConflictResolution, instances: ECal.Component[], extra: string | null, opflags: ECal.OperationFlags, cancellable: Gio.Cancellable | null): [ /* returnType */ boolean, /* outNewUid */ string, /* outNewExtra */ string ]
    /**
    ...
    on(sigName: "refresh-completed", callback: CalMetaBackend.RefreshCompletedSignalCallback): number
    once(sigName: "refresh-completed", callback: CalMetaBackend.RefreshCompletedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "source-changed", callback: CalMetaBackend.SourceChangedSignalCallback): number
    once(sigName: "source-changed", callback: CalMetaBackend.SourceChangedSignalCallback): number
    off(handlerId: number): number
...
export interface DataCalView extends Gio.Initable {
    ...
    off(handlerId: number): number
    emit(sigName: "notify::object-path", ...args: any[]): void
    connect(sigName: "notify::sexp", callback: any): number
    on(sigName: "notify::sexp", callback: any): number
    once(sigName: "notify::sexp", callback: any): number
    off(handlerId: number): number
