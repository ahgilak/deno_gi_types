...
export interface Pixbuf extends Gio.Icon, Gio.LoadableIcon {
    ...
    connect(sigName: "notify::has-alpha", callback: any): number
    on(sigName: "notify::has-alpha", callback: any): number
    once(sigName: "notify::has-alpha", callback: any): number
    off(handlerId: number): number
    ...
    connect(sigName: "notify::n-channels", callback: any): number
    on(sigName: "notify::n-channels", callback: any): number
    once(sigName: "notify::n-channels", callback: any): number
    off(handlerId: number): number
    emit(sigName: "notify::n-channels", ...args: any[]): void
    connect(sigName: "notify::pixel-bytes", callback: any): number
    on(sigName: "notify::pixel-bytes", callback: any): number
    once(sigName: "notify::pixel-bytes", callback: any): number
    off(handlerId: number): number
...
export interface PixbufLoader {
    ...
    on(sigName: "area-prepared", callback: PixbufLoader.AreaPreparedSignalCallback): number
    once(sigName: "area-prepared", callback: PixbufLoader.AreaPreparedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "area-updated", callback: PixbufLoader.AreaUpdatedSignalCallback): number
    once(sigName: "area-updated", callback: PixbufLoader.AreaUpdatedSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "closed", callback: PixbufLoader.ClosedSignalCallback): number
    once(sigName: "closed", callback: PixbufLoader.ClosedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "closed", ...args: any[]): void
    connect(sigName: "size-prepared", callback: PixbufLoader.SizePreparedSignalCallback): number
    on(sigName: "size-prepared", callback: PixbufLoader.SizePreparedSignalCallback): number
    once(sigName: "size-prepared", callback: PixbufLoader.SizePreparedSignalCallback): number
    off(handlerId: number): number
