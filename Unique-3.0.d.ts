...
export interface App {
    ...
    on(sigName: "message-received", callback: App.MessageReceivedSignalCallback): number
    once(sigName: "message-received", callback: App.MessageReceivedSignalCallback): number
    ...
    connect(sigName: "notify::is-running", callback: any): number
    on(sigName: "notify::is-running", callback: any): number
    once(sigName: "notify::is-running", callback: any): number
    off(handlerId: number): number
