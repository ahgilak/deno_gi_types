...
export interface H264Decoder {
    ...
    connect(sigName: "notify::compliance", callback: any): number
    on(sigName: "notify::compliance", callback: any): number
    once(sigName: "notify::compliance", callback: any): number
    off(handlerId: number): number
...
export interface Vp9Decoder {
     ...
     */
    duplicatePicture(frame: GstVideo.VideoCodecFrame, picture: Vp9Picture): Vp9Picture
    /**
     ...
     * @param frameHdr 
     */
    newSequence(frameHdr: Vp9FrameHeader): Gst.FlowReturn
    /**
