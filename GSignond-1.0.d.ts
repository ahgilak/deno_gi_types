...
export interface Plugin {
    ...
    on(sigName: "error", callback: Plugin.ErrorSignalCallback): number
    once(sigName: "error", callback: Plugin.ErrorSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "error", ...args: any[]): void
    connect(sigName: "refreshed", callback: Plugin.RefreshedSignalCallback): number
    on(sigName: "refreshed", callback: Plugin.RefreshedSignalCallback): number
    once(sigName: "refreshed", callback: Plugin.RefreshedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "refreshed", ...args: any[]): void
    connect(sigName: "response", callback: Plugin.ResponseSignalCallback): number
    on(sigName: "response", callback: Plugin.ResponseSignalCallback): number
    once(sigName: "response", callback: Plugin.ResponseSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "response", ...args: any[]): void
    connect(sigName: "response-final", callback: Plugin.ResponseFinalSignalCallback): number
    on(sigName: "response-final", callback: Plugin.ResponseFinalSignalCallback): number
    once(sigName: "response-final", callback: Plugin.ResponseFinalSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "status-changed", callback: Plugin.StatusChangedSignalCallback): number
    once(sigName: "status-changed", callback: Plugin.StatusChangedSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "status-changed", message: string, ...args: any[]): void
    connect(sigName: "store", callback: Plugin.StoreSignalCallback): number
    on(sigName: "store", callback: Plugin.StoreSignalCallback): number
    once(sigName: "store", callback: Plugin.StoreSignalCallback): number
    off(handlerId: number): number
    ...
    on(sigName: "user-action-required", callback: Plugin.UserActionRequiredSignalCallback): number
    once(sigName: "user-action-required", callback: Plugin.UserActionRequiredSignalCallback): number
    off(handlerId: number): number
    emit(sigName: "user-action-required", ...args: any[]): void

    // Class property signals of GSignond-1.0.GSignond.Plugin

    connect(sigName: "notify::mechanisms", callback: any): number
    on(sigName: "notify::mechanisms", callback: any): number
    once(sigName: "notify::mechanisms", callback: any): number
    off(handlerId: number): number
